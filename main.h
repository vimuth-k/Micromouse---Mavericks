 ...
 *   — defined in main.c, see the "HAL PERIPHERAL HANDLES" block there)
 *   is declared here as `extern` so any driver can take a pointer to
 *   it without redeclaring the type itself:
 *
 *       imu_init(&hi2c1);
 *       oled_init(&hi2c1);
 *
 *   This is why nearly every .c file in the project — motors.c,
 *   battery.c, oled.c, imu.c, utils.c, safety.c,
