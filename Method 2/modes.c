...
#include "scheduler.h"
#include "main.h"     /* HAL_Delay, LED_TOGGLE (via pins.h through main.h chain) */
#include "pins.h"     /* LED_TOGGLE() */
#include <stdio.h>
 ...
 *          scheduler while idling so battery monitoring, log flushing,
 *          and the LED heartbeat keep running even after the mode's
 *          task is done. Only a board reset gets out of this loop.
 *
